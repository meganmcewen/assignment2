%Part 2a
%This is the general code for Part 2 - it uses a box with contacts inside
%that have different conductivity, then solves for the electric field and 
%current density to see how these affect the solution.

clear all

%constants
L = 150; %size of matrix in x
